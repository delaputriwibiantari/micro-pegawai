...
class SdmStrukturalStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tanggal_penetapan_jabatan' => 'required|date',
            'tanggal_mulai_menjabat' => 'required|date',
    ...
    public function messages(): array
    {
        return [
            ...
            'tanggal_penetapan_jabatan.required' => 'Tanggal Penetapan Jabatan wajib diisi.',
            'tanggal_penetapan_jabatan.date' => 'Tanggal Penetapan Jabatan harus berupa tanggal.',
            'tanggal_mulai_menjabat.required' => 'Tanggal Mulai Menjabat wajib diisi.',
