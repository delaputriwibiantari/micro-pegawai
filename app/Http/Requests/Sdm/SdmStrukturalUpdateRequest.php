...
class SdmStrukturalUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'id_unit' => 'sometimes|integer|exists:master_unit,id_unit',
            'id_jabatan' => 'sometimes|integer|exists:master_jabatan,id_jabatan',
            'nomor_sk' => 'sometimes|string|max:50',
            'tanggal_penetapan_jabatan' => 'sometimes|date',
            'tanggal_mulai_menjabat' => 'sometimes|date',
    ...
    public function attributes(): array
    {
        return [
            ...
            'id_jabatan' => 'Jabatan',
            'nomor_sk' => 'Nomor SK',
            'tanggal_penetapan_jabatan' => 'Tanggal Penetapan Jabatan',
            'tanggal_mulai_menjabat' => 'Tanggal Mulai Menjabat',
    ...
    public function messages(): array
    {
        return [
            ...
            'tanggal_penetapan_jabatan.date' => 'Tanggal Penetapan Jabatan harus berupa tanggal.',
            'tanggal_mulai_menjabat.date' => 'Tanggal Mulai Menjabat harus berupa tanggal.',
