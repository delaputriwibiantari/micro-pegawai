...
use App\Http\Controllers\Sdm\SdmStrukturalStoreController;
use App\Http\Controllers\Sdm\SdmStrukturalUpdateController;
use App\Http\Requests\Sdm\SdmStrukturalStoreRequest;
use App\Http\Requests\Sdm\SdmStrukturalUpdateRequest;
use App\Models\sdm\SdmStruktural as SdmSdmStruktural;
use App\Models\SdmStruktural;
use App\Services\Sdm\SdmStrukturalService;
use App\Services\Tools\FileUploadService;
use App\Services\Tools\ResponseService;
use App\services\Tools\TransactionService;
use Illuminate\Contracts\View\View as ViewView;
use Illuminete\Contracts\View\View;
...
final class SdmStrukturalController extends Controller
{
    ...
    public function index(string $uuid): ViewView
    {
