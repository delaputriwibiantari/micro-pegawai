        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Hubungan Keluarga</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_hubungan_keluarga"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" id="edit_jk"
                                        class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                        data-allow-clear="true" data-placeholder="Pilih Jenis Kelamin" required>
