...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Jenis Pendidikan</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1 ">Data Jenis Dokumen</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title='Tambah Jenis Dokumen'>Tambah Jenis Dokumen</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    <div
                        ...
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data jenis Dokumen.</span>
                            </div>
                        </div>
                    </div>
                    <div
    ...
    @include('admin.ref.jenis_dokumen.view.detail')
    @include('admin.ref.jenis_dokumen.view.create')
    @include('admin.ref.jenis_dokumen.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.ref.jenis_dokumen.script.list')
    @include('admin.ref.jenis_dokumen.script.create')
    @include('admin.ref.jenis_dokumen.script.edit')
    @include('admin.ref.jenis_dokumen.script.detail')
@endsection
