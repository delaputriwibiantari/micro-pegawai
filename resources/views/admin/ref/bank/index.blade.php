...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1">Data Bank</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6"
                               ...
                               title="Tambah Bank">Tambah Bank</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-5">
                    <div class="notice d-flex border-primary mb-4 rounded border border-dashed p-4 shadow bg-hover-light-dark">
                        <div class="d-flex flex-stack fs-sm-8 fs-lg-6">
                            <div class="row">
                                <span class="text-gray-700">Berikut ini adalah data bank.</span>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive mb-8 shadow p-4 mx-0 border-hover-dark border-primary border-1 border-dashed fs-sm-8 fs-lg-6 rounded-2">
                        <table id="example"
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                ...
                                <th class="min-w-120px">Kode Swift</th>
                                <th class="min-w-120px">Customer Service</th>
                            </tr>
                            </thead>
    ...
    @include('admin.ref.bank.view.detail')
    @include('admin.ref.bank.view.create')
    @include('admin.ref.bank.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.ref.bank.script.list')
    @include('admin.ref.bank.script.create')
    @include('admin.ref.bank.script.edit')
    @include('admin.ref.bank.script.detail')
@endsection
