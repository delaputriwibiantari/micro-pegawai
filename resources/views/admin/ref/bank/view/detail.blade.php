        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex flex-column mb-2">
                    ...
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_nama_bank"></p>
                </div>
                <div class="d-flex flex-column mb-2">
                    <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                        <span>Kode Swift</span>
                    </label>
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_kode_swift"></p>
                </div>
                <div class="d-flex flex-column mb-2">
                    <label class="d-flex align-items-center fs-sm-8 fs-lg-6 fw-bolder mb-1">
                        <span>Customer Service</span>
                    </label>
                    <p class="fw-light fs-sm-8 fs-lg-6" id="detail_customer_service"></p>
                </div>
            </div>
