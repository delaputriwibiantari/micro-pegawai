<script defer>
    $("#form_edit").on("show.bs.modal", function (e) {
        ...
        const detail = '{{ route('admin.ref.jenjang-pendidikan.show', [':id']) }}';

        DataManager.fetchData(detail.replace(':id', id))
            .then(function (response) {
                if (response.success) {
                    $("#edit_jenjang_pendidikan").val(response.data.jenjang_pendidikan);
                } else {
        ...
        $("#bt_submit_edit").on("submit", function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    const input = {
                        "jenjang_pendidikan": $("#edit_jenjang_pendidikan").val()
                    };
