...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Data Cuti</li>
@endsection
...
@section('content')
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title="Tambah SDM">Tambah Cuti</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="example"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-60px">Jenis Cuti</th>
    ...
    @include('admin.absensi.cuti.view.detail')
    @include('admin.absensi.cuti.view.create')
    @include('admin.absensi.cuti.view.edit')
    @include('admin.absensi.cuti.view.approval')
@endsection
...
@section('javascript')
    ...
    @include('admin.absensi.cuti.script.list')
    @include('admin.absensi.cuti.script.create')
    @include('admin.absensi.cuti.script.edit')
    @include('admin.absensi.cuti.script.detail')
    @include('admin.absensi.cuti.script.approval')
