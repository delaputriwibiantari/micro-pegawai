...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Data Lembur</li>
@endsection
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title="Tambah SDM">Tambah Lembur</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="example"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-60px">Tanggal</th>
                                    <th class="min-w-120px">Jam Pelaksanaan</th>
...
@section('javascript')
    ...
    @include('admin.absensi.lembur.script.list')
    @include('admin.absensi.lembur.script.create')
    @include('admin.absensi.lembur.script.edit')
    @include('admin.absensi.lembur.script.detail')
    @include('admin.absensi.lembur.script.approval')
