                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex flex-column mb-2">
                            ...
                            <p id="detail_nama_anggota" class="fw-light fs-sm-8 fs-lg-6"></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-column mb-2">
                            <label class="fs-sm-8 fs-lg-6 fw-bolder mb-1">Nomer Peserta</label>
                            <p id="detail_nomer_peserta" class="fw-light fs-sm-8 fs-lg-6"></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex flex-column mb-2">
