...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">periode</li>
@endsection
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1 ">Data periode</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title="Tambah periode">Tambah periode</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="example"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0 fs-sm-8 fs-lg-6">
                                    ...
                                    <th class="min-w-100px">Tanggal Non Aktif</th>
...
@section('javascript')
    ...
    @include('admin.master.periode.script.list')
