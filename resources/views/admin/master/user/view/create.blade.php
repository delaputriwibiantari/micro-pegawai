                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="email" id="email" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="password" id="password" class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                       required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
