...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1 ">Data User</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title="Tambah User">Tambah User</a>
                        </div>
                    </div>
                </div>
    ...
    @include('admin.master.user.view.create')
    @include('admin.master.user.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.master.user.script.list')
    @include('admin.master.user.script.create')
    @include('admin.master.user.script.edit')
