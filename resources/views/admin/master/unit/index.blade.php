...
@section('list')
    ...
    <li class="breadcrumb-item text-dark">Unit</li>
@endsection
...
@section('content')
            ...
            <div class="card mb-xl-8 mb-5 border-2 shadow">
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder mb-1 ">Data Unit</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a type="button" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6" data-bs-toggle="modal"
                               data-bs-target="#form_create" title="Tambah Unit">Tambah Unit</a>
                        </div>
                    </div>
                </div>
    ...
    @include('admin.master.unit.view.detail')
    @include('admin.master.unit.view.create')
    @include('admin.master.unit.view.edit')
@endsection
...
@section('javascript')
    ...
    @include('admin.master.unit.script.list')
    @include('admin.master.unit.script.create')
    @include('admin.master.unit.script.edit')
    @include('admin.master.unit.script.detail')
@endsection
