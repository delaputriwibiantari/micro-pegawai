        ...
        <form method="post" id="bt_submit_create">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Penggajian Manual</h5>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                    name="periode_id" id="periode_id" data-allow-clear="true" data-placeholder="Umum Id"
                                    >
                                </select>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary fs-sm-8 fs-lg-6">Proses</button>
                </div>
            </div>
        </form>
    </div>
